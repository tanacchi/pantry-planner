...
export class ShoppingItemController {
  ...
  getItems(@Query("userId", ParseIntPipe) userId: number): Promise<ShoppingItemResponseDto[]> {
  ...
  @ApiResponse({ status: 200, type: ShoppingItemResponseDto })
  getItem(@Param("id", ParseIntPipe) id: number): Promise<ShoppingItemResponseDto | null> {
  ...
  createItem(@Body() dto: CreateShoppingItemRequestDto): Promise<ShoppingItemResponseDto> {
