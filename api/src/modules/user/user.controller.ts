...
export class UserController {
  ...
  createUser(@Body() dto: CreateUserRequestDto): Promise<UserDetailResponseDto> {
  ...
  getUserDetail(@Param("id", ParseIntPipe) id: number): Promise<UserDetailResponseDto> {
  ...
  getUserByLineUid(@Param("lineUid") lineUid: string): Promise<UserResponseDto> {
  ...
  getUserDetailByLineUid(@Param("lineUid") lineUid: string): Promise<UserDetailResponseDto> {
