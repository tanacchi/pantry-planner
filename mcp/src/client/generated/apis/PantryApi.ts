...
export class PantryApi extends runtime.BaseAPI {
  /**
   */
  async pantryControllerCreatePantryRaw(
    requestParameters: PantryControllerCreatePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PantryResponseDto>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PantryResponseDtoFromJSON(jsonValue),
    );
  }

  /**
   */
  async pantryControllerCreatePantry(
    requestParameters: PantryControllerCreatePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async pantryControllerDeletePantryRaw(
    requestParameters: PantryControllerDeletePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async pantryControllerDeletePantry(
    requestParameters: PantryControllerDeletePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
  ...
  /**
   */
  async pantryControllerGetPantriesRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<PantryResponseDto>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(PantryResponseDtoFromJSON),
    );
  }

  /**
   */
  async pantryControllerGetPantries(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<PantryResponseDto>> {
  ...
  /**
   */
  async pantryControllerGetPantriesByUserRaw(
    requestParameters: PantryControllerGetPantriesByUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<PantryResponseDto>>> {
    ...
    const response = await this.request(
      {
        path: `/pantries/by-user/{userId}`.replace(
          `{${"userId"}}`,
  ...
  /**
   */
  async pantryControllerGetPantriesByUser(
    requestParameters: PantryControllerGetPantriesByUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<PantryResponseDto>> {
    const response = await this.pantryControllerGetPantriesByUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async pantryControllerGetPantryRaw(
    requestParameters: PantryControllerGetPantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PantryResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async pantryControllerGetPantry(
    requestParameters: PantryControllerGetPantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PantryResponseDto> {
  ...
  /**
   */
  async pantryControllerGetPantryDetailRaw(
    requestParameters: PantryControllerGetPantryDetailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PantryDetailResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
        "id",
    ...
    const response = await this.request(
      {
        path: `/pantries/{id}/detail`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters["id"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PantryDetailResponseDtoFromJSON(jsonValue),
    );
  }

  /**
   */
  async pantryControllerGetPantryDetail(
    requestParameters: PantryControllerGetPantryDetailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PantryDetailResponseDto> {
    const response = await this.pantryControllerGetPantryDetailRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async pantryControllerGetPantryDetailsByUserRaw(
    requestParameters: PantryControllerGetPantryDetailsByUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<PantryDetailResponseDto>>> {
    if (requestParameters["userId"] == null) {
      throw new runtime.RequiredError(
        "userId",
    ...
    const response = await this.request(
      {
        path: `/pantries/by-user/{userId}/detail`.replace(
          `{${"userId"}}`,
          encodeURIComponent(String(requestParameters["userId"])),
        ),
        method: "GET",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(PantryDetailResponseDtoFromJSON),
    );
  }

  /**
   */
  async pantryControllerGetPantryDetailsByUser(
    requestParameters: PantryControllerGetPantryDetailsByUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<PantryDetailResponseDto>> {
    const response = await this.pantryControllerGetPantryDetailsByUserRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async pantryControllerUpdatePantryRaw(
    requestParameters: PantryControllerUpdatePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<PantryResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async pantryControllerUpdatePantry(
    requestParameters: PantryControllerUpdatePantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<PantryResponseDto> {
