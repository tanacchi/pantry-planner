...
import type { CreateUserRequestDto, UserDetailResponseDto, UserResponseDto } from "../models/index";
import {
...
export class UserApi extends runtime.BaseAPI {
  ...
  async userControllerCreateUserRaw(
  ...
  ): Promise<runtime.ApiResponse<UserDetailResponseDto>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UserDetailResponseDtoFromJSON(jsonValue),
    );
  }
  ...
  /**
   */
  async userControllerGetUserByLineUidRaw(
    requestParameters: UserControllerGetUserByLineUidRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserResponseDto>> {
    ...
    const response = await this.request(
      {
        path: `/users/by-line-uid/{lineUid}`.replace(
          `{${"lineUid"}}`,
          encodeURIComponent(String(requestParameters["lineUid"])),
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async userControllerGetUserByLineUid(
    requestParameters: UserControllerGetUserByLineUidRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserResponseDto> {
  ...
  /**
   */
  async userControllerGetUserDetailRaw(
    requestParameters: UserControllerGetUserDetailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserDetailResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async userControllerGetUserDetail(
    requestParameters: UserControllerGetUserDetailRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserDetailResponseDto> {
  ...
  /**
   */
  async userControllerGetUserDetailByLineUidRaw(
    requestParameters: UserControllerGetUserDetailByLineUidRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UserDetailResponseDto>> {
    if (requestParameters["lineUid"] == null) {
      throw new runtime.RequiredError(
    ...
    const response = await this.request(
      {
        path: `/users/by-line-uid/{lineUid}/detail`.replace(
          `{${"lineUid"}}`,
          encodeURIComponent(String(requestParameters["lineUid"])),
        ),
        method: "GET",
  ...
  /**
   */
  async userControllerGetUserDetailByLineUid(
    requestParameters: UserControllerGetUserDetailByLineUidRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UserDetailResponseDto> {
    const response = await this.userControllerGetUserDetailByLineUidRaw(
      requestParameters,
      initOverrides,
    );
    return await response.value();
  ...
  /**
   */
  async userControllerGetUsersRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
