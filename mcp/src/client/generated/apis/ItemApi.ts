...
import type { CreateItemRequestDto, ItemResponseDto } from "../models/index";
import {
...
export class ItemApi extends runtime.BaseAPI {
  /**
   */
  async itemControllerCreateItemRaw(
    requestParameters: ItemControllerCreateItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ItemResponseDto>> {
  ...
  /**
   */
  async itemControllerCreateItem(
    requestParameters: ItemControllerCreateItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async itemControllerDeleteItemRaw(
    requestParameters: ItemControllerDeleteItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ...
  /**
   */
  async itemControllerDeleteItem(
    requestParameters: ItemControllerDeleteItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<void> {
  ...
  /**
   */
  async itemControllerGetItemRaw(
    requestParameters: ItemControllerGetItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ItemResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async itemControllerGetItemsRaw(
    requestParameters: ItemControllerGetItemsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ItemResponseDto>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(ItemResponseDtoFromJSON),
    );
  }

  /**
   */
  async itemControllerGetItems(
    requestParameters: ItemControllerGetItemsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ItemResponseDto>> {
  ...
  /**
   */
  async itemControllerGetItemsByPantryRaw(
    requestParameters: ItemControllerGetItemsByPantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<ItemResponseDto>>> {
    ...
    const response = await this.request(
      {
        path: `/items/by-pantry/{pantryId}`.replace(
          `{${"pantryId"}}`,
          encodeURIComponent(String(requestParameters["pantryId"])),
        ),
        method: "GET",
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async itemControllerGetItemsByPantry(
    requestParameters: ItemControllerGetItemsByPantryRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<ItemResponseDto>> {
  ...
  /**
   */
  async itemControllerUpdateItemRaw(
    requestParameters: ItemControllerUpdateItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ItemResponseDto>> {
    if (requestParameters["id"] == null) {
      throw new runtime.RequiredError(
  ...
  /**
   */
  async itemControllerUpdateItem(
    requestParameters: ItemControllerUpdateItemRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ItemResponseDto> {
