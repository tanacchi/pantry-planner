...
export default function ShoppingListUser() {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      <div className="w-full px-4 py-4 bg-white shadow-sm">
        <h1 className="text-lg font-bold text-center">買い物リスト</h1>
      </div>
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1 min-w-0">
                  <h3 className="font-medium text-base text-gray-900 mb-1">{item.name}</h3>
      ...
      <div className="bg-white rounded-t-2xl w-full max-h-[80vh] overflow-y-auto">
        ...
        <div className="px-6 py-6">
          <fetcher.Form method="post" className="space-y-6">
            <div>
              <label htmlFor="name" className="block mb-2 font-medium text-gray-700">商品名</label>
              <input
                id="name"
                type="text"
                name="name"
            ...
            <div>
              <label htmlFor="category" className="block mb-2 font-medium text-gray-700">カテゴリ</label>
              <select id="category" name="category" className="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-base focus:border-blue-500 focus:outline-none">
